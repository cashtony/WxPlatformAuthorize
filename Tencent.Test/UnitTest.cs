...
namespace Tencent.Test
{
    ...
    public class UnitTest
    {
        ...
        [TestMethod]
        public void TestEncryptVerifyTicketMsg()
        {
            //公众平台上开发者设置的token, appID, EncodingAESKey
            string sToken = "QDG6eK";
            string sAppID = "wx5823bf96d3bd56c7";
            ...
            string sReqTimeStamp = "1409659813";
            string sReqNonce = "1372623149";
            string sRespData = "<xml><AppId><![CDATA[wx5823bf96d3bd56c7]]></AppId><CreateTime><![CDATA[1413192605]]></CreateTime><InfoType>component_verify_ticket</InfoType><ComponentVerifyTicket><![CDATA[TestComponentVerifyTicketValue]]></ComponentVerifyTicket></xml>";
            string sEncryptMsg = ""; //xml格式的密文
            int ret = 0;
            ret = wxcpt.EncryptMsg(sRespData, sReqTimeStamp, sReqNonce, ref sEncryptMsg);
            System.Console.WriteLine("sEncryptMsg");
